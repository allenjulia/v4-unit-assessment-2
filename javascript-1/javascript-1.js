...
//CODE HERE
  let phone1 = new Phone ('SamSung', 'Galaxy S', 5, 'black', false)

  
  let phone2 = new Phone ('Apple', 'iPhone X', 12, 'gold', false)
  
  let phone3 = new Phone ('Apple', 'iPhone 8', 10, 'silver', false)
